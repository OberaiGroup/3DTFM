...
!          endif
		...
		elseif(jelemtype.eq.311) then
		elseif(jelemtype.eq.312) then	
		elseif(jelemtype.eq.313) then	
		elseif(jelemtype.eq.315) then
        elseif(jelemtype.eq.317) then
        elseif(jelemtype.eq.667) then		
        else
