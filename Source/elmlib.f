...
c     LIST OF ELEMENTS
     ...
     $        uel_meas)
      else if (ltype.eq.311) then     !!DS: add elem311
        call elem311 (ielem,itask,pelem,nnode,est,efo,eln,xel,elemd,uel,
     $        uel_meas)
	  else if (ltype.eq.312) then     !!DS: add elem312
        call elem312 (ielem,itask,pelem,nnode,est,efo,eln,xel,elemd,uel,
     $        uel_meas)
	  else if (ltype.eq.313) then     !!DS: add elem313
        call elem313 (ielem,itask,pelem,nnode,est,efo,eln,xel,elemd,uel,
     $        uel_meas)	 
	  else if (ltype.eq.315) then     !!DS: add elem315
        call elem315 (ielem,itask,pelem,nnode,est,efo,eln,xel,elemd,uel,
     $        uel_meas)	 	 
      else if (ltype.eq.308) then
        call elem308 (ielem,itask,pelem,nnode,est,efo,eln,xel,elemd,uel,
     $        uel_meas)
      else if (ltype.eq.317) then
        call elem317 (ielem,itask,pelem,nnode,est,efo,eln,xel,elemd,uel,
     $        uel_meas)
      else if (ltype.eq.667) then
        call elem667 (ielem,itask,pelem,nnode,est,efo,eln,xel,elemd,uel,
     $        uel_meas)
      else
